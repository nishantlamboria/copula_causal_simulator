...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "random DAGs, generation, evaluation."
        )
    )
...
def main() -> None:
    ...
    if args.rebuild_coupling_library or not coupling_library_exists:
        print("\nCoupling library missing or rebuild requested. Building coupling library...")
    ...
    # ------------------------------------------------------------------
    # 2. Build or reuse conditional D-vine library for indegree 2
    # ------------------------------------------------------------------
    ...
    if args.rebuild_conditional_vines or not conditional_vine_exists:
        print("\nConditional D-vine library missing or rebuild requested. Building it...")
        ...
        print("\nConditional D-vine library already exists. Reusing existing library.")
