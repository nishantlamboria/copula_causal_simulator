...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate synthetic data from a DAG with max indegree <= 2."
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="outputs/generated_indegree2",
...
def main() -> None:
    ...
    validate_dag(adjacency, max_allowed_indegree=2)
    ...
    metadata = {
        ...
        "generator": "indegree_two_conditional_vine",
