...
Input: `reports\tables\breast_cancer\conditional_vine_summary_indegree2.csv`

- Successful two-parent mechanisms: **660**
- Mechanisms selecting more than one bin: **254** (38.5%)
- Mechanisms retaining the simplifying assumption: **406**
- Median raw best-score improvement over the simplified model: **0.002602**
