...
Input: `reports\tables\diabetes\conditional_vine_summary_indegree2.csv`

- Successful two-parent mechanisms: **360**
- Mechanisms selecting more than one bin: **86** (23.9%)
- Mechanisms retaining the simplifying assumption: **274**
- Median raw best-score improvement over the simplified model: **0.000053**
